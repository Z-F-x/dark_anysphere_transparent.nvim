...
function M.setup()
  ...
  local groups = {
    ...
    Statement = { fg = M.minty },
    Conditional = { fg = M.minty },
    Repeat = { fg = M.minty },
    Label = { fg = M.minty },
    Operator = { fg = M.grey_07 },
    Keyword = { fg = M.minty },
    Exception = { fg = M.minty },
    PreProc = { fg = M.minty },
    Include = { fg = M.minty },
    Define = { fg = M.minty },
    Macro = { fg = M.minty },
    PreCondit = { fg = M.minty },
    Type = { fg = M.semantic.class },
    StorageClass = { fg = M.minty },
    Structure = { fg = M.minty },
    Typedef = { fg = M.minty },
    ...
    ["@punctuation.special"] = { fg = M.minty },
    ["@constant"] = { fg = M.yellow_01 },
    ...
    ["@constructor"] = { fg = M.minty },
    ["@conditional"] = { fg = M.minty },
    ["@repeat"] = { fg = M.minty },
    ["@label"] = { fg = M.minty },
    ["@keyword"] = { fg = M.minty },
    ["@keyword.function"] = { fg = M.minty },
    ["@keyword.operator"] = { fg = M.minty },
    ["@operator"] = { fg = M.grey_07 },
    ["@exception"] = { fg = M.minty },
    ["@type"] = { fg = M.semantic.class },
